      ...
      >
        <Container className="h-100">
          <div className="d-flex h-100">
            ...
            <span>8408041959</span>
          </Button>
          <Button
            className="contact-btns bg-customBlue mr-2 shadow border-0 py-1"
            onClick={() =>
              window.open("https://www.linkedin.com/in/utkarsh-dalmia-039578192/", "_blank")
            }
          >
          ...
          <Button
            className="contact-btns bg-customBlue mr-2 shadow border-0 py-1"
            onClick={() =>
              window.open("https://github.com/Udalmia", "_blank")
            }
          >
            ...
            onClick={() =>
              window.open(
                'mailto:utkarshdalmia3@gmail.com?subject="Hello !"',
                "_blank"
              )
            }
          >
            <FontAwesomeIcon size="1x" icon={faEnvelope} />
            <span>utkarshdalmia3@gmail.com</span>
          </Button>
                  </div>
                  <br />
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        'https://drive.google.com/file/d/1IZ3ZLnm2sN-rwgDMW-CDdqOMPWB38lF9/view?usp=sharing"',
                        "_blank"
                      )
                    }
                  >
